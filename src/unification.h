...
types::type_t::map unify(types::type_t::ref a, types::type_t::ref b, env_t &env);
types::type_t::map unify_many(const types::type_t::refs &as, const types::type_t::refs &b, env_t &env);
