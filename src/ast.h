...
struct pattern_block_t {
  pattern_block_t(predicate_t *predicate, expr_t *result)
...
struct match_t : public expr_t {
  match_t(expr_t *scrutinee, pattern_blocks_t pattern_blocks)
...
struct tuple_predicate_t : public predicate_t {
  tuple_predicate_t(location_t location,
...
struct ctor_predicate_t : public predicate_t {
  ctor_predicate_t(location_t location,
                   std::vector<predicate_t *> params,
...
struct as_t : public expr_t {
  as_t(expr_t *expr, types::scheme_t::ref scheme, bool force_cast)
...
struct lambda_t : public expr_t {
  lambda_t(identifier_t var,
           types::type_t::ref param_type,
...
struct conditional_t : public expr_t {
  conditional_t(expr_t *cond, expr_t *truthy, expr_t *falsey)
...
struct instance_t {
  instance_t(identifier_t type_class_id,
             types::type_t::ref type,
...
struct program_t {
  program_t(const std::vector<decl_t *> &decls,
            const std::vector<type_class_t *> &type_classes,
            const std::vector<instance_t *> &instances,
            expr_t *expr)
