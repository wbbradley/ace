...
std::string ARROW_TYPE_OPERATOR = ace::tld::mktld("std", "->");
std::string PTR_TYPE_OPERATOR = ace::tld::mktld("std", "Ptr");
std::string REF_TYPE_OPERATOR = ace::tld::mktld("std", "Ref");
...
std::string BOOL_TYPE = ace::tld::mktld("std", "Bool");
std::string MAYBE_TYPE = ace::tld::mktld("maybe", "Maybe");
std::string VECTOR_TYPE = ace::tld::mktld("vector", "Vector");
std::string MAP_TYPE = ace::tld::mktld("map", "Map");
std::string SET_TYPE = ace::tld::mktld("set", "Set");
std::string STRING_TYPE = ace::tld::mktld("string", "String");
